...
let NodeLocalFile$1 = class NodeLocalFile {
...
async function openH5File$1(options) {
...
async function openH5File(options) {
    ...
    if (options.path) { // A file path
        options.reader = new NodeLocalFile$1(options);
            }

    if (options.indexPath) {
        options.indexReader = new NodeLocalFile$1({path: options.indexPath});
            }

    return openH5File$1(options)
}

exports.openH5File = openH5File;
